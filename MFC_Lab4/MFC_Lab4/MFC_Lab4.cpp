...
// MFC_Lab4.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CMFCLab4App, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CMFCLab4App

CMFCLab4App::CMFCLab4App()
{
...
// Единственный объект CMFCLab4App

CMFCLab4App theApp;


// Инициализация CMFCLab4App

BOOL CMFCLab4App::InitInstance()
{
