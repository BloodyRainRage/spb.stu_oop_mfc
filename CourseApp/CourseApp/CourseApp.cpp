...
// CourseApp.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CCourseAppApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CCourseAppApp

CCourseAppApp::CCourseAppApp()
{
...
// Единственный объект CCourseAppApp

CCourseAppApp theApp;


// Инициализация CCourseAppApp

BOOL CCourseAppApp::InitInstance()
{
