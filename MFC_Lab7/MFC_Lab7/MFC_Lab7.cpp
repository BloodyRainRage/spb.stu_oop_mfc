...
// MFC_Lab7.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CMFCLab7App, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CMFCLab7App

CMFCLab7App::CMFCLab7App()
{
...
// Единственный объект CMFCLab7App

CMFCLab7App theApp;


// Инициализация CMFCLab7App

BOOL CMFCLab7App::InitInstance()
{
