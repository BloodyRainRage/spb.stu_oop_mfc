...
// MFC_Lab1.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CMFCLab1App, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CMFCLab1App

CMFCLab1App::CMFCLab1App()
{
...
// Единственный объект CMFCLab1App

CMFCLab1App theApp;


// Инициализация CMFCLab1App

BOOL CMFCLab1App::InitInstance()
{
