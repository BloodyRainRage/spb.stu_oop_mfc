...
// MFC_Lab5.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CMFCLab5App, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CMFCLab5App

CMFCLab5App::CMFCLab5App()
{
...
// Единственный объект CMFCLab5App

CMFCLab5App theApp;


// Инициализация CMFCLab5App

BOOL CMFCLab5App::InitInstance()
{
