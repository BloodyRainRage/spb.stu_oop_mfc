...
// MFC_Lab11.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CMFCLab11App, CWinAppEx)
...
// Создание CMFCLab11App

CMFCLab11App::CMFCLab11App() noexcept
{
...
// Единственный объект CMFCLab11App

CMFCLab11App theApp;


// Инициализация CMFCLab11App
...
// Обработчики сообщений CMFCLab11App
...
// Методы загрузки или сохранения настроек CMFCLab11App

void CMFCLab11App::PreLoadState()
{
	BOOL bNameValid;
	CString strName;
...
void CMFCLab11App::LoadCustomState()
{
}

void CMFCLab11App::SaveCustomState()
{
}
