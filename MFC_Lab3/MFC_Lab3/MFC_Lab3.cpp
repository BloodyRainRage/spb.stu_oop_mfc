...
// MFC_Lab3.cpp: определяет поведение классов для приложения.
//

#include "pch.h"
#include "framework.h"
#include "MFC_Lab3.h"
#include "MFC_Lab3Dlg.h"
...
BEGIN_MESSAGE_MAP(CMFCLab3App, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CMFCLab3App

CMFCLab3App::CMFCLab3App()
{
...
// Единственный объект CMFCLab3App

CMFCLab3App theApp;


// Инициализация CMFCLab3App

BOOL CMFCLab3App::InitInstance()
{
