...
// MFC_Lab10.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CMFCLab10App, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CMFCLab10App

CMFCLab10App::CMFCLab10App()
{
...
// Единственный объект CMFCLab10App

CMFCLab10App theApp;


// Инициализация CMFCLab10App

BOOL CMFCLab10App::InitInstance()
{
