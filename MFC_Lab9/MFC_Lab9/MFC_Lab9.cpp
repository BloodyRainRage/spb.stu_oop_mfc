...
// MFC_Lab9.cpp: определяет поведение классов для приложения.
//

#include "pch.h"
#include "framework.h"
#include "MFC_Lab9.h"
#include "MFC_Lab9Dlg.h"
...
BEGIN_MESSAGE_MAP(CMFCLab9App, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CMFCLab9App

CMFCLab9App::CMFCLab9App()
{
...
// Единственный объект CMFCLab9App

CMFCLab9App theApp;


// Инициализация CMFCLab9App

BOOL CMFCLab9App::InitInstance()
{
